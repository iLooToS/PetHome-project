...
const pets = [
  {
    ...
    age: 2,
    description:
      "Бакс обожает играть с мячами и гулять на свежем воздухе. Он полон энергии и готов быть вашим верным компаньоном на долгие прогулки и активные игры в парке. Несмотря на свою активность, Бакс также любит проводить время на диване.",
    isSex: true,
    isCastration: false,
    isTemperament: true,
    isChipping: false,
  ...
  },
  {
    ...
    age: 4,
    description:
      "Лулу — активная и игривая собака, которая обожает бегать за мячиком и принимать участие в веселых играх. Несмотря на свои небольшие размеры, у неё огромное сердце, полное любви и преданности! Она прекрасно ладит с детьми и другими животными, что делает её отличным выбором для семейного питомца.",
    isSex: false,
    isCastration: false,
    isTemperament: true,
    isChipping: false,
  ...
  },
  {
    ...
    name: "Милка",
    age: 2,
    description: "Милка очень дружелюбна и общительна, она быстро привязывается к людям и всегда ищет компанию, чтобы поиграть или просто провести время рядом. Её любимые занятия — охота за игрушечными мышами, уютные сны на подоконнике и, конечно, время на ручках у своих хозяев.",
    isSex: false,
    isCastration: false,
    isTemperament: true,
    isChipping: true,
